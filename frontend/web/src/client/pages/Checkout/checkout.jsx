...
const Checkout = () => {
  ...
  const validate = () => {
    ...
    if (!formData.address.trim()) {
      ...
      !/^[\w\s,\-àáạảãâầấậẩẫăằắặẳẵèéẹẻẽêềếệểễìíịỉĩòóọỏõôồốộổỗơờớợởỡùúụủũưừứựửữỳýỵỷỹđÀÁẠẢÃÂẦẤẬẨẪĂẰẮẶẲẴÈÉẸẺẼÊỀẾỆỂỄÌÍỊỈĨÒÓỌỎÕÔỒỐỘỔỖƠỜỚỢỞỠÙÚỤỦŨƯỪỨỰỬỮỲÝỴỶỸĐ()]+$/.test(
        formData.address
      )
    ) {
      newErrors.address =
        "Địa chỉ chỉ được chứa chữ cái, số, dấu cách, dấu phẩy, dấu gạch ngang và dấu ngoặc";
      valid = false;
    }
    if (!formData.city) {
  ...
  return (
    <>
      ...
      <div
        className="checkout-page-container py-5"
        style={{
          width: "100vw",
          position: "relative",
          left: "50%",
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-4 mb-3">
                              ...
                              >
                                ...
                                {Object.entries(availableDistricts || {}).map(
                                  ([key, district]) => (
                                    <option key={key} value={key}>
                                      {district.Name}
                                    </option>
                            ...
                            <div className="col-md-4 mb-3">
                              ...
                              >
                                ...
                                {Object.entries(availableWards || {}).map(
                                  ([key, ward]) => (
                                    <option key={key} value={key}>
                                      {ward.Name}
                                    </option>
                          ...
                          >
                            ...
                            <span>
                              ...
                              {voucherFromState.discountType === "amount"
                                ? `Giảm ${voucherFromState.discountValue.toLocaleString(
                                  "vi-VN"
                                )}đ`
